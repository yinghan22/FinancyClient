<template>
  <div class="d-flex flex-row w-100 h-100 m-0 p-0">
    ...
    <el-dialog v-model="export_file_dialog_visible" destroy-on-close title="导出为文件">
      <ExportFileForm :success="()=>{ export_file_dialog_visible=false;}"></ExportFileForm>
    </el-dialog>
  </div>
...
import JobResponseList from '../../components/admin/JobResponseList/index.vue';

import GroupList from '../../components/admin/GroupList/index.vue';

import BudgetList from '../../components/admin/BudgetList/index.vue';
import AnnualWorkPlanList from '../../components/admin/AnnualWorkPlanList/index.vue';
import AnnualEconomicBusinessPlanList from '../../components/admin/AnnualEconomicBusinessPlanList/index.vue';
import EconomyClassifyList from '../../components/admin/EconomyClassifyList/index.vue';
...
const admin_list = reactive([
  ...
  {label: '经济分类', comp: markRaw(EconomyClassifyList)},
